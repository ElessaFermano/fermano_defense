...
class Artworks extends Db implements DbConnection
{
    ...
    public function create($params)
    {
        ...
        $sql = "INSERT INTO artworks(title, medium, artist) VALUES('$title','$medium','$artist')";
    ...
    public function update($params)
    {
        ...
        $sql = "UPDATE artworks SET title = '$title', medium = '$medium', artist = '$artist'
        where id = '$id'";
